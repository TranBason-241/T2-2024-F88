$(document).ready(function () {
  ...
  getDataFormParam = () => {
    ...
    if (ans) {
      questionDirec = document.querySelectorAll('input[type="checkbox"][name="q-1"]');
...
const sendPostRequest = async () => {
  ...
  coreValue = data2["2. “Theo bạn” thông thường ai sẽ nắm vai trò “làm chủ” gia đình?"];
  targetData = chuyenDoiKhongDau(coreValue);
